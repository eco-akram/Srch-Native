        ...
        <Box className="justify-center rounded-2xl bg-[#D3D3D3] p-6 shadow-md">
          ...
          <Box className="justify-center rounded-2xl bg-[#f0f0f0] p-6 shadow-md">
            <Text className="p-2 text-center color-black" size={'xl'}>
              Ši programėlė yra klausimynas, kuris padeda vartotojams pasirinkti išmaniųjų namų
              tiekėjus pagal jų norus ir poreikius. Atsakydami į klausimus, vartotojai gali gauti
              rekomendacijas, kurios geriausiai atitinka jų pageidavimus ir gyvenimo būdą.
            </Text>
          </Box>
        </Box>
      </Box>
